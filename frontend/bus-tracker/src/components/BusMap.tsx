...
import { MapContainer, TileLayer, Marker, Popup, useMap, Polyline, Circle, CircleMarker, useMapEvents } from 'react-leaflet';
...
export function BusMap({ position, data, history = [], userLocation, userAccuracy = 0 }: BusMapProps) {
  ...
  return (
    <div className="busmap-relative-container">
      ...
      >
        ...
        {history.length > 0 && <Polyline pathOptions={limeOptions} positions={history} />}
